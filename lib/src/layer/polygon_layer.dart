...
class Polygon {
  ...
  Polygon({
    ...
    this.colorPoint = const Color(0xFFFFFF00),
  ...
  void _paintPolygon(Canvas canvas, Rect rect) {
    ...
    if (null != polygonOpt.holeOffsetsList) {
      ...
      paintCircle
        ...
        ..color = polygonOpt.colorPoint;
      polygonOpt.offsets.forEach((element) {
        canvas.drawCircle(element, 3, paintCircle);
      });
